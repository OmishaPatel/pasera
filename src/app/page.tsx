...
// Root landing page with header/footer that adapts to auth state

import LandingPageContent from './(public)/page';
import { Header } from '@/components/layout/Header';
import { Footer } from '@/components/layout/Footer';
import { BottomNav } from '@/components/layout/BottomNav';
import { Home, Search, User, Calendar, Plus } from 'lucide-react';
...
export default function HomePage() {
  ...
  // Bottom navigation - changes based on auth state
