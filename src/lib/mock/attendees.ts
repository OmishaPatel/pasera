...
export const mockAttendees: EventAttendee[] = [
  ...
  { id: 'att-8', event_id: 'event-1', user_id: 'user-2', status: 'waitlist', responded_at: '2026-01-26T18:00:00Z', created_at: '2026-01-26T18:00:00Z' },
  { id: 'att-9', event_id: 'event-1', user_id: 'user-3', status: 'waitlist', responded_at: '2026-01-26T19:00:00Z', created_at: '2026-01-26T19:00:00Z' },
  { id: 'att-12', event_id: 'event-1', user_id: 'user-6', status: 'waitlist', responded_at: '2026-01-26T22:00:00Z', created_at: '2026-01-26T22:00:00Z' },
  { id: 'att-13', event_id: 'event-1', user_id: 'user-7', status: 'waitlist', responded_at: '2026-01-27T08:00:00Z', created_at: '2026-01-27T08:00:00Z' },
  { id: 'att-14', event_id: 'event-1', user_id: 'user-8', status: 'waitlist', responded_at: '2026-01-27T09:00:00Z', created_at: '2026-01-27T09:00:00Z' },
  ...
  { id: 'att-37', event_id: 'event-3', user_id: 'user-6', status: 'waitlist', responded_at: '2026-01-21T14:00:00Z', created_at: '2026-01-21T14:00:00Z' },
  { id: 'att-38', event_id: 'event-3', user_id: 'user-7', status: 'waitlist', responded_at: '2026-01-21T15:00:00Z', created_at: '2026-01-21T15:00:00Z' },
  { id: 'att-39', event_id: 'event-3', user_id: 'user-8', status: 'waitlist', responded_at: '2026-01-21T16:00:00Z', created_at: '2026-01-21T16:00:00Z' },
  { id: 'att-40', event_id: 'event-3', user_id: 'user-1', status: 'waitlist', responded_at: '2026-01-22T10:00:00Z', created_at: '2026-01-22T10:00:00Z' },
  { id: 'att-41', event_id: 'event-3', user_id: 'user-2', status: 'waitlist', responded_at: '2026-01-22T11:00:00Z', created_at: '2026-01-22T11:00:00Z' },
  { id: 'att-42', event_id: 'event-3', user_id: 'user-3', status: 'waitlist', responded_at: '2026-01-22T12:00:00Z', created_at: '2026-01-22T12:00:00Z' },
  ...
  { id: 'att-50', event_id: 'event-4', user_id: 'user-1', status: 'waitlist', responded_at: '2026-01-24T10:00:00Z', created_at: '2026-01-24T10:00:00Z' },
  { id: 'att-51', event_id: 'event-4', user_id: 'user-2', status: 'waitlist', responded_at: '2026-01-24T11:00:00Z', created_at: '2026-01-24T11:00:00Z' },
  { id: 'att-52', event_id: 'event-4', user_id: 'user-3', status: 'waitlist', responded_at: '2026-01-24T12:00:00Z', created_at: '2026-01-24T12:00:00Z' },
  { id: 'att-53', event_id: 'event-4', user_id: 'user-4', status: 'waitlist', responded_at: '2026-01-24T13:00:00Z', created_at: '2026-01-24T13:00:00Z' },
  { id: 'att-54', event_id: 'event-4', user_id: 'user-5', status: 'waitlist', responded_at: '2026-01-24T14:00:00Z', created_at: '2026-01-24T14:00:00Z' },
];
...
export const getAttendeesByStatus = (eventId: string, status: 'going' | 'waitlist'): EventAttendee[] =>
